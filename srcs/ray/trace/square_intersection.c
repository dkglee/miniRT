...
/*   Updated: 2021/04/07 17:19:11 by deulee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	square_intersection_point(t_vec origin, t_vec dir, t_object *list)
{
	...
	if (ft_vec_size(sq.center_to_point) <= limit)
		return (dis);
	return (INFINITY);
}
